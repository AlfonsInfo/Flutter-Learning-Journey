              ...
              child: Card(
                ...
                child: Stack(children: <Widget>[
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(image: AssetImage("assets/sunset.jpg"),fit: BoxFit.cover
                  ),)),
                  Container(
                    margin : EdgeInsets.fromLTRB(20,50 + MediaQuery.of(context).size.height * 0.35, 20,20),
                    child: Center(
                      child: Column(children: [
                        Text("Beautiful Sunset at Paddy Field",maxLines: 2, textAlign: TextAlign.center, style: TextStyle(color: Color(0xFFF56D5D),fontSize: 25),),
                        Container(
                          margin:  EdgeInsets.fromLTRB(0, 20, 0,15),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text("Posted on ",maxLines: 2,  style: TextStyle(color: Colors.grey , fontSize: 12),),
                              Text("Feb 1, 2023",maxLines: 2,  style: TextStyle(color: Color(0xFFF56D5D),fontSize: 12),),
                            ],
                          ),
                    ...
                    children: [
                      ...
                      Spacer(flex: 1,),
                      // Text
                      Text("88", style: TextStyle(color: Colors.grey),),
                      Spacer(flex: 5,),
                      // Icon
                      Icon(Icons.comment, size:18 , color: Colors.grey),
                      Spacer(flex: 1,),
                      // Text
                      Text("10292", style: TextStyle(color: Colors.grey),),
                      Spacer(flex: 10,)
                    ],
                  )
                      ]),
